...
class WP_Taxi_Installer {
    ...
    public static function install() {
        ...
        self::create_roles();
        // Erstelle notwendige Datenbanktabellen (Beispiel)
        // self::create_tables();
    ...
    /*
    // Beispiel für die Erstellung einer Datenbanktabelle
    private static function create_tables() {
        global $wpdb;
        $charset_collate = $wpdb->get_charset_collate();
        $table_name = $wpdb->prefix . 'taxi_rides'; // Beispiel Tabellenname
        ...
        $sql = "CREATE TABLE $table_name (
            ...
            status varchar(20) NOT NULL DEFAULT 'pending', // pending, accepted, ongoing, completed, cancelled
    ...
    */
    ...
    /*
    // Beispiel für das Setzen von Standardoptionen
    private static function set_default_options() {
        add_option( 'wp_taxi_plugin_google_maps_api_key', '' );
